This is a demo package for Eclipse Tradista.

It is based on Eclipse Tradista v3.1.0.
...
1. Execute startTradistaDB.sh
2. Execute startTradistaServer.sh
3. Execute startTradistaClient.sh
...
Feel free to request features or report bugs on https://github.com/eclipse-tradista/tradista
If you see missing useful data on this demo environment, feel free to request it on https://github.com/oasuncion/tradista-demo
